def intialize_light_array(xSize=1000,ySize=1000,defaultBrightness=0):
	lightArray = {}
	light = {}
	seperator = ','
	for x in range(0,xSize):
		for y in range(0,ySize):
			lightArray[str(x) +  seperator + str(y)] = defaultBrightness
	return lightArray
...
for light in myLights:
	totalBrightness += myLights[light]

print("Total brightness of lights: " + str(totalBrightness))
